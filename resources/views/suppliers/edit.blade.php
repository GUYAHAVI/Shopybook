                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control @error('country') is-invalid @enderror" 
                               name="country" value="{{ old('country', $supplier->country) }}">
                        @error('country')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control @error('company_registration') is-invalid @enderror" 
                               name="company_registration" value="{{ old('company_registration', $supplier->company_registration) }}">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control @error('tax_number') is-invalid @enderror" 
                               name="tax_number" value="{{ old('tax_number', $supplier->tax_number) }}">
                        @error('tax_number')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select class="form-select @error('payment_terms') is-invalid @enderror" name="payment_terms">
                            ...
                            <option value="Net 0 (Immediate)" {{ old('payment_terms', $supplier->payment_terms) == 'Net 0 (Immediate)' ? 'selected' : '' }}>Net 0 (Immediate)</option>
                            <option value="Net 7" {{ old('payment_terms', $supplier->payment_terms) == 'Net 7' ? 'selected' : '' }}>Net 7 (7 days)</option>
                            <option value="Net 15" {{ old('payment_terms', $supplier->payment_terms) == 'Net 15' ? 'selected' : '' }}>Net 15 (15 days)</option>
                            <option value="Net 30" {{ old('payment_terms', $supplier->payment_terms) == 'Net 30' ? 'selected' : '' }}>Net 30 (30 days)</option>
                            <option value="Net 60" {{ old('payment_terms', $supplier->payment_terms) == 'Net 60' ? 'selected' : '' }}>Net 60 (60 days)</option>
                            <option value="Net 90" {{ old('payment_terms', $supplier->payment_terms) == 'Net 90' ? 'selected' : '' }}>Net 90 (90 days)</option>
                            <option value="COD (Cash on Delivery)" {{ old('payment_terms', $supplier->payment_terms) == 'COD (Cash on Delivery)' ? 'selected' : '' }}>COD (Cash on Delivery)</option>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" step="0.01" class="form-control @error('credit_limit') is-invalid @enderror" 
                               name="credit_limit" value="{{ old('credit_limit', $supplier->credit_limit) }}" min="0">
                        @error('credit_limit')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <textarea class="form-control @error('notes') is-invalid @enderror" 
                                  name="notes" rows="3">{{ old('notes', $supplier->notes) }}</textarea>
                        @error('notes')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
