...
@section('title', 'Add Employee - ' . $business->name)
    ...
    <div class="row">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h1 class="h3 mb-0">{{ t('add_employee') }}</h1>
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0">{{ t('employee_information') }}</h5>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('employees.store', ['business_id' => $business->id]) }}">
                        @csrf
                        ...
                        <div class="d-flex justify-content-end">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save me-2"></i>{{ t('save_employee') }}
                            </button>
                        </div>
                    </form>
                </div>
