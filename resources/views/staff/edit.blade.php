    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card p-4" style="background: var(--card-bg); border: 1px solid var(--border-color);">
                <h2 class="fw-bold mb-4" style="color: var(--text-primary);">Edit Staff Member</h2>
                <form method="POST" action="{{ route('staff.update', $staff) }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="salary" name="salary" value="{{ old('salary', $staff->salary) }}" placeholder="Enter monthly salary"
                               style="border: 1px solid var(--border-color); background: var(--card-bg); color: var(--text-primary);">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="contact" name="contact" value="{{ old('contact', $staff->contact) }}"
                               style="border: 1px solid var(--border-color); background: var(--card-bg); color: var(--text-primary);">
