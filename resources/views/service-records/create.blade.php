...
<div class="container py-4">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card p-4">
                <h2 class="fw-bold mb-4" style="color:#020258;">Record Service</h2>
                <form method="POST" action="{{ route('service-records.store') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" step="0.01" class="form-control" id="commission" name="commission" value="{{ old('commission') }}" required>
                        @error('commission')<div class="text-danger small">{{ $message }}</div>@enderror
                    </div>
                    <div class="mb-3">
                        <label for="performed_at" class="form-label">Date & Time *</label>
                        <input type="datetime-local" class="form-control" id="performed_at" name="performed_at" value="{{ old('performed_at') }}" required>
                    ...
                    <div class="d-flex justify-content-end">
                        ...
                        <button type="submit" class="btn btn-primary">Record Service</button>
                    </div>
                </form>
            </div>
        </div>
