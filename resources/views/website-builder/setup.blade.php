...
<div class="container-fluid">
        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
            <div>
                ...
                <p class="text-muted mb-0" style="font-size: 0.95rem;">
                    Build a stunning website for <strong>{{ $business->name }}</strong> in minutes
                </p>
            </div>
    ...
    <!-- AI Auto-Build Feature - Prominent Card at Top -->
    <div class="card mb-4" style="background: linear-gradient(135deg, {{ $business->isEnterprise() ? '#667eea 0%, #764ba2' : '#3b82f6 0%, #2563eb' }} 100%); border: none; position: relative; overflow: hidden;">
        <!-- Decorative Elements -->
            ...
            <div class="row align-items-center g-4">
                <div class="col-lg-8">
                    <div class="d-flex align-items-start gap-3">
                        ...
                        <div>
                            <h3 class="mb-2" style="color: white; font-weight: 700; font-size: 1.75rem;">
                                @if($business->isEnterprise())
                                    <i class="fas fa-crown me-2" style="color: #fbbf24;"></i>AI Auto-Build Your Website
                                @else
                                    <i class="fas fa-sparkles me-2"></i>AI Auto-Build - Enterprise Feature
                                @endif
                            </h3>
                            <p class="mb-3" style="color: rgba(255,255,255,0.95); font-size: 1.05rem; line-height: 1.6;">
                                Let Claude AI build your <strong>ENTIRE website automatically</strong> in just 1-2 minutes! 
                                Complete with 5-7 pages, professional content, and SEO optimization.
                            </p>
                            <div class="d-flex flex-wrap gap-3" style="color: rgba(255,255,255,0.9); font-size: 0.95rem;">
                ...
                <div class="col-lg-4 text-lg-end">
                    <button type="button" class="btn btn-light btn-lg px-4 py-3" id="autoBuildBtn" 
                            style="font-weight: 700; white-space: nowrap; box-shadow: 0 8px 20px rgba(0,0,0,0.2);"
                            data-is-enterprise="{{ $business->isEnterprise() ? 'true' : 'false' }}">
                        @if($business->isEnterprise())
                            <i class="fas fa-magic me-2"></i>Auto-Build Now
                        @else
                            <i class="fas fa-crown me-2"></i>Upgrade to Use
                        @endif
                    </button>
                    @if(!$business->isEnterprise())
                    <p class="mb-0 mt-2" style="color: rgba(255,255,255,0.85); font-size: 0.875rem;">
                        <i class="fas fa-info-circle me-1"></i>Enterprise plan required
                    </p>
                    @else
                    <p class="mb-0 mt-2" style="color: rgba(255,255,255,0.85); font-size: 0.875rem;">
    ...
    <div class="text-center my-4" style="position: relative;">
        ...
        <span style="position: relative; background: var(--bg-primary); padding: 0 1rem; color: var(--text-muted); font-weight: 600; font-size: 0.875rem;">
            OR BUILD MANUALLY
        </span>
    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    // Check if coming from dashboard rebuild
    const urlParams = new URLSearchParams(window.location.search);
    const isRebuild = urlParams.get('rebuild') === 'ai';
    
    if (isRebuild && document.getElementById('autoBuildBtn')) {
        // Auto-trigger AI build button after a brief delay
        setTimeout(() => {
            document.getElementById('autoBuildBtn').click();
        }, 500);
    }
});
</script>
