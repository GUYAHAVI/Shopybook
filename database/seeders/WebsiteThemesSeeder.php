    ...
    public function run(): void
    {
        $themes = [
            ...
            [
                'name' => 'Jeriah Modern',
                'slug' => 'jeriah-modern',
                'description' => 'A stunning, bold modern design with deep navy and electric gold accents — crafted for businesses that want to command attention',
                'category' => 'business',
                'style' => 'modern',
                'is_free' => true,
                'is_active' => true,
                ...
                'available_sections' => ['hero', 'features', 'about', 'services', 'products', 'stats', 'testimonials', 'team', 'gallery', 'pricing', 'faq', 'cta', 'contact'],
            ],
            [
                'name' => 'Startup Launch',
                'slug' => 'startup-launch',
