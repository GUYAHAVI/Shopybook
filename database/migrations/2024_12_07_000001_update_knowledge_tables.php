...
return new class extends Migration
{
    ...
    {
        // Add missing columns to knowledge_data table (skip if table doesn't exist)
        if (Schema::hasTable('knowledge_data')) {
        ...
        // Add missing columns to trending_analysis table (skip if table doesn't exist)
        if (Schema::hasTable('trending_analysis')) {
